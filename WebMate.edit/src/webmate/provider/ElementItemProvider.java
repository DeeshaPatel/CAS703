...
/**
 * This is the item provider adapter for a {@link webmate.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_count_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_count_feature", "_UI_Element_type"),
				 WebmatePackage.Literals.ELEMENT__COUNT,
				 true,
				 false,
				 false,
	...
	protected void addElementNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_elementName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_elementName_feature", "_UI_Element_type"),
				 WebmatePackage.Literals.ELEMENT__ELEMENT_NAME,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addElementClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_elementClass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_elementClass_feature", "_UI_Element_type"),
				 WebmatePackage.Literals.ELEMENT__ELEMENT_CLASS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebmatePackage.Literals.ELEMENT__ELEMENT_ID,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAttributesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_attributes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_attributes_feature", "_UI_Element_type"),
				 WebmatePackage.Literals.ELEMENT__ATTRIBUTES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Element_type") + " " + element.getCount();
	}
