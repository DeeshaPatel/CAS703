...
/**
 * This is the item provider adapter for a {@link webmate.ID} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IDItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ID_idName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ID_idName_feature", "_UI_ID_type"),
				 WebmatePackage.Literals.ID__ID_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ID)object).getIdName();
