...
public class WebmateAdapterFactory extends AdapterFactoryImpl {
	...
	protected WebmateSwitch<Adapter> modelSwitch =
		new WebmateSwitch<Adapter>() {
			...
			@Override
			public Adapter caseInputSymbol(InputSymbol object) {
				return createInputSymbolAdapter();
			}
			@Override
			public Adapter caseInputWord(InputWord object) {
				return createInputWordAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link webmate.StringInput <em>String Input</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link webmate.InputSymbol <em>Input Symbol</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createInputSymbolAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link webmate.InputWord <em>Input Word</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createInputWordAdapter() {
		return null;
	}
